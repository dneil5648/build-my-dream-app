                ...
                {loadingAllBalances || loadingAccounts ? (
                  ...
                  <div className="space-y-2 max-h-[120px] overflow-y-auto">
                    {accounts.map((account: PaxosAccount, index: number) => {
                      ...
                      const percentage = totalBalance > 0 ? (accountTotal / totalBalance) * 100 : 0;
                      
                      return (
                        <div key={account.id} className="flex items-center justify-between text-sm">
                          <span className="text-foreground truncate max-w-[100px]" title={account.nickname || `Wallet ${index + 1}`}>
